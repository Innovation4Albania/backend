...
public sealed class ApplicationRolesTests
{
    ...
    [InlineData(ApplicationRoles.DrejtorEkosistemiStartupeve, true)]
    [InlineData(ApplicationRoles.DrejtorProgrametMbeshtetjes, true)]
    [InlineData(ApplicationRoles.DrejtorFinancimiAlternativ, true)]
    [InlineData(ApplicationRoles.DrejtorProjekteBe, true)]
    ...
    [InlineData(ApplicationRoles.PerfaqesuesInstitucioni, true)]
    [InlineData(ApplicationRoles.DrejtorAgjencie, false)]
    [InlineData(ApplicationRoles.DrejtorEkosistemiStartupeve, false)]
    [InlineData(ApplicationRoles.DrejtorProgrametMbeshtetjes, false)]
    [InlineData(ApplicationRoles.DrejtorFinancimiAlternativ, false)]
    [InlineData(ApplicationRoles.DrejtorProjekteBe, false)]
    ...
    [InlineData(ApplicationRoles.DrejtorEkosistemiStartupeve, "Drejtor për ekosistemin e Start-upeve")]
    [InlineData(ApplicationRoles.DrejtorProgrametMbeshtetjes, "Drejtor për programet e mbështetjes")]
    [InlineData(ApplicationRoles.DrejtorFinancimiAlternativ, "Drejtor për zhvillimin e financimit alternativ")]
    [InlineData(ApplicationRoles.DrejtorProjekteBe, "Drejtor për zhvillimin e projekteve me BE-në")]
